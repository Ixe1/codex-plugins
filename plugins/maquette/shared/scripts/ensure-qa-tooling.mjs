...
function usage() {
  console.error([
    ...
    "  --check-image-prep     Check optional sharp dependency for reference image sharpening",
...
const output = {
  ...
  notes: [
    ...
    "Install optional image preprocessing dependencies only when the run will sharpen raster references.",
