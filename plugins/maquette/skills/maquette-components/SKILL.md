...
Keep CSS under `.maquette/components/css/` and JS under `.maquette/components/js/`. Do not put batch artifacts in nested per-batch folders by default; nested folders are legacy-compatible only.
